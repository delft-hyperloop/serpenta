        ...
        <g id="localiser">
            <g id="track">
                <g id="progress_container" bind:this={progress_container}>
                    ...
                    <g id="path-turning" bind:this={path_turn}>
                        ...
                        />
                        <path
                            bind:this={progress_turn}
                            d="M10 25.7224H347.125L344.878 25.7226C459 25.7226 550 53.4999 639.3 77.4151L859.555 138.097"
                            stroke="#4D9C89"
                            stroke-width="6"
                        />
                    </g>
            ...
            <g id="labels">
                {#if showLabels}
                    ...
                    <text x="453" y="55" fill="#EFF0F0" transform="rotate(12,450,70)" font-size="12"
                        >Lane-switch curve
                    </text>
                    <text x="705" y="116" fill="#EFF0F0" transform="rotate(15,680,125)" font-size="12"
                        >Backward C
                    </text>
                    <text x="708" y="75" fill="#EFF0F0" transform="rotate(15,680,125)" font-size="12">Forward C </text>
                {/if}
            </g>
        </g>
