    ...
    {#if vertical}
        <svg {height} viewBox="0 0 51 114" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="battery">
                ...
                <path
                    id="battery-edge"
                    d="M20 1H32C33.6569 1 35 2.34315 35 4V6H17V4C17 2.34315 18.3431 1 20 1Z"
                    fill="#EFF0F0"
                    stroke="#EFF0F0"
                    stroke-width="2"
                />
                <text
                    ...
                    y="60"
                    fill="white"
                    class="font-number {height > 50 ? `text-lg` : `text-sm`}"
                    text-anchor="middle">{percentage}%</text
                >
            </g>
        </svg>
    {:else}
        <svg {height} viewBox="0 0 115 52" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="battery">
                <rect
                    ...
                    y={100 - percentage}
                    width="51"
                    height={7.5 + percentage}
                    rx="8"
                    transform="rotate(90 107.5 0.5)"
                    {fill}
                />
                <rect
                    id="battery-body"
                ...
                <text
                    ...
                    y="32"
                    fill="white"
                    class="font-number {height > 30 ? 'text-lg' : 'text-2xl'}"
                    text-anchor="middle">{percentage}%</text
                >
            </g>
        </svg>
