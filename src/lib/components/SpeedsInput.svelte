<script lang="ts">
    ...
    const RouteStepNames: RouteStep[] = [
        "ForwardA",
        "ForwardB",
        "ForwardC",
        "BackwardsA",
    ...
    async function onFormSubmit() {
        ...
        await invoke("set_route", { route: modifiedRouteConfig })
            .then(r => {
    ...
    async function importSpeeds() {
        ...
        await invoke("speeds_from_u64", { speeds: speedInputValue })
            .then(r => {
    ...
    async function importRoutes() {
        ...
        await invoke("positions_from_u64", { positions: routesInputValue })
            .then(r => {
    ...
    async function processSpeeds() {
        ...
        await invoke("speeds_to_u64", { speeds: speedsToU8(CurrentRouteConfig.speeds) })
            .then(r => {
    ...
    async function processRoutes() {
        ...
        await invoke("positions_to_u64", { positions: modifiedPos })
            .then(r => {
    ...
    async function validateCurrentRouteConfig() {
        ...
        await invoke("validate_route", { route: modifiedRouteConfig })
            .then(r => {
...
{#if $modalStore[0]}
    <div class="modal-example-form w-modal-wide card p-4 shadow-xl space-y-4">
        ...
        <div class="grid modal-grid grid-rows-[1fr 2fr] h-full gap-4 col-span-1">
                ...
                <svg viewBox="0 0 919 148" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="localiser">
                        ...
                        <g id="labels">
                            <text
                                x="165"
                                y="10"
                                fill={focusedInput === "ForwardA" ? "#4D9C89" : "#EFF0F0"}
                                font-size="12"
                                >Forward A
                            </text>
                            <text
                                x="162"
                                y="50"
                                fill={focusedInput === "BackwardA" ? "#4D9C89" : "#EFF0F0"}
                                font-size="12"
                                >Backward A
                            </text>
                            <text
                                x="405"
                                y="10"
                                fill={focusedInput === "LaneSwitchStraight" ? "#4D9C89" : "#EFF0F0"}
                                font-size="12"
                            ...
                            <text
                                x="731"
                                y="10"
                                fill={focusedInput === "ForwardB" ? "#4D9C89" : "#EFF0F0"}
                                font-size="12"
                                >Forward B
                            </text>
                            <text
                                x="728"
                                y="50"
                                fill={focusedInput === "BackwardB" ? "#4D9C89" : "#EFF0F0"}
                                font-size="12"
                                >Backward B
                            </text>
                            <text
                                x="453"
                                y="55"
                                fill={focusedInput === "LaneSwitchCurved" ? "#4D9C89" : "#EFF0F0"}
                            ...
                            <text
                                x="705"
                                y="116"
                                fill={focusedInput === "ForwardC" ? "#4D9C89" : "#EFF0F0"}
                            ...
                            <text
                                x="708"
                                y="75"
                                fill={focusedInput === "BackwardC" ? "#4D9C89" : "#EFF0F0"}
                                transform="rotate(15,680,125)"
                                font-size="12"
                                >Forward C
                            </text>
                    ...
                    <g filter="url(#filter0_d_64_411)">
                        ...
                        <rect
                            ...
                            height="1"
                            rx="0.5"
                            transform="rotate(-138.181 198.4 17.0792)"
                            fill="#4D9C89"
                        />
                        ...
                        <rect
                            ...
                            height="1"
                            rx="0.5"
                            transform="rotate(-138.181 763.4 19.0792)"
                            fill="#4D9C89"
                        />
                        ...
                        <rect
                            ...
                            height="1"
                            rx="0.5"
                            transform="rotate(-138.181 763.4 19.0791)"
                            fill="#4D9C89"
                        />
                        <rect
                            x="764.188"
                            ...
                            height="1"
                            rx="0.5"
                            transform="rotate(179.998 764.188 36.6966)"
                            fill="#4D9C89"
                        />
                        <path
                        ...
                        <rect
                            ...
                            height="1"
                            rx="0.5"
                            transform="rotate(41.8165 754.787 35.6178)"
                            fill="#4D9C89"
                        />
                        <rect
                            x="740.787"
                            ...
                            height="1"
                            rx="0.5"
                            transform="rotate(15.4693 740.787 96.8915)"
                            fill="#4D9C89"
                        />
                        <path
                        ...
                        <rect
                            ...
                            height="1"
                            rx="0.5"
                            transform="rotate(-122.712 749.559 100.439)"
                            fill="#4D9C89"
                        />
                        <rect
                            x="745.619"
                            ...
                            height="1"
                            rx="0.5"
                            transform="rotate(-164.533 745.619 117.628)"
                            fill="#4D9C89"
                        />
                        <path
                        ...
                        <rect
                            ...
                            height="1"
                            rx="0.5"
                            transform="rotate(57.2857 736.847 114.081)"
                            fill="#4D9C89"
                        />
                        <rect
                            x="198.199"
                            ...
                            height="1"
                            rx="0.5"
                            transform="rotate(-179.773 198.199 36.737)"
                            fill="#4D9C89"
                        />
                        <path
                        ...
                        <rect
                            ...
                            height="1"
                            rx="0.5"
                            transform="rotate(42.0461 188.804 35.6205)"
                            fill="#4D9C89"
                        />
                    </g>
                    <defs>
            ...
            <div class="col-span-1 row-span-2 h-[500px] overflow-auto">
                ...
                >
                    <div class="flex items-center justify-between p-2 bg-surface-800 rounded-lg cursor-move m-2">
                        ...
                        <button type="button" class="btn rounded-lg" on:click={() => removeRouteStep(index)}>
            ...
            <div class="col-span-2 w-full">
                {#each inputs as input}
                    <label class="text-lg grid labels-grid gap-2 mb-2">
                        ...
                        <input
                            class={`input rounded-lg px-1 ${invalidInputs.includes(input) ? "text-error-400" : ""}`}
                            type="number"
                            max="500"
                            min="-500"
                            bind:value={CurrentRouteConfig.speeds[input]}
                            pattern="^-?[0-9]*$"
                            on:focus={() => (focusedInput = input)}
            ...
            >
                {#each RouteStepNames as step}
                    <div class="flex items-center justify-between w-full p-2 bg-surface-800 rounded-lg">
                        <span>{step}</span>
                        <button type="button" class="btn rounded-none" on:click={() => onRouteStepClick(step)}>
                            <Icon
                                icon="mdi:plus"
            ...
            <div class="col-span-4 flex gap-4">
                <div class="grid grid-cols-4 grid-rows-2 gap-4">
                    <button
                        class="btn border-2 border-primary-500 text-primary-500 font-medium rounded-lg"
        ...
        <footer class="modal-footer {parent.regionFooter}">
            <button class="btn {parent.buttonNeutral} rounded-lg" on:click={parent.onClose}> Cancel </button>
            <button class="btn bg-primary-500 rounded-lg" on:click={onFormSubmit}> Run Configuration </button>
        </footer>
    </div>
{/if}
